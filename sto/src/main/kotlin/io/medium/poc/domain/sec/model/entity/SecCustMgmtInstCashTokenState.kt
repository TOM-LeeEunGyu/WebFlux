...
/**
 * 증권사 고객관리기관 캐시토큰 State
 */
@Entity
@Table(name = "SEC_CUST_MGMT_INST_CASH_TOKEN_STATE")
class SecCustMgmtInstCashTokenState(
...
@Embeddable
data class SecCustMgmtInstCashTokenStateMultiKeys(
    /** 고객관리기관번호 */
