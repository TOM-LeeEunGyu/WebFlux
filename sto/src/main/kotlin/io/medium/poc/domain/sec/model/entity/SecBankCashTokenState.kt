 ...
 */
@Entity
@Table(name = "SEC_BANK_CASH_TOKEN_STATE")
class SecBankCashTokenState(

    /** composite id */
    @EmbeddedId
    val compositeId: SecBankCashTokenStateMultiKeys,
...
@Embeddable
data class SecBankCashTokenStateMultiKeys(
    /** 은행기관번호 */
