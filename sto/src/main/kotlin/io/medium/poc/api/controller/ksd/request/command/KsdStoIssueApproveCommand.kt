...
@Schema(description = "예탁원 공모신청 승인 요청 객체")
data class KsdStoIssueApproveCommand(
    ...
    fun compositeId(): KsdStoIssueAplctMultiKeys {
        return KsdStoIssueAplctMultiKeys(
