...
data class OtcEnforcementResultCommand(
    ...
    fun toOtcStoTrading(trdNo: Long): OtcStoTrading {
        val compositeId = OtcStoTradingMultiKeys(
            selCustMgmtInstNo = selCustMgmtInstNo,
            selCustMgmtInstAcntNo = selCustMgmtInstAcntNo,
            buyCustMgmtInstNo = buyCustMgmtInstNo,
            buyCustMgmtInstAcntNo = buyCustMgmtInstAcntNo,
            stoItemNo = stoItemNo,
            trdNo = trdNo,
        )
        return OtcStoTrading(
            compositeId = compositeId,
            tradeType = TradeType.fromCode(trdType),
            tradeQty = trdQty,
            trdAmt = trdAmt,
